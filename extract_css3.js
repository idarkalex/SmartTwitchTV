...
styleBlocks.forEach((b, i) => {
    console.log(`  ${i}: ${b.inner.length} chars, starts with: ${b.fullBlock.slice(0, 50)}`);
});

// Main block is index 0, mockup is the one with id="mockup-ui-style"
const mainStyle = styleBlocks[0].inner;
