...
function ru_RULang() {
    ...
    STR_START_AT_FEED = 'Всегда запускать приложение с лентой подписанных каналов';
    STR_START_AT_FEED_SUMMARY = 'Эта опция открывает боковую панель с подписанными каналами и превью стрима при запуске. Отключает "Восстановление воспроизведения".';
    ...
    STR_CUSTOM_PROXY = 'Пользовательский прокси';
    STR_CUSTOM_PROXY_SUMMARY = 'Использовать пользовательский URL прокси-сервера, нажмите enter для редактирования URL';
    STR_CUSTOM_PROXY_URL = 'URL пользовательского прокси';
    STR_CUSTOM_PROXY_URL_PROMPT = 'Введите URL пользовательского прокси (URL должен заканчиваться на /):';
    STR_CUSTOM_PROXY_HAS_TOKEN = 'Пользовательский прокси имеет токен';
    STR_CUSTOM_PROXY_HAS_TOKEN_SUMMARY =
        'Если URL прокси уже содержит токен, отключите эту опцию, чтобы токен не добавлялся повторно';
    STR_CUSTOM_PROXY_HAS_PARAMETER = 'Пользовательский прокси имеет параметры';
    STR_CUSTOM_PROXY_HAS_PARAMETER_SUMMARY =
        'Если URL прокси уже содержит параметры, включите эту опцию, чтобы параметры добавлялись как строка запроса';
